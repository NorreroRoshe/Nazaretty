        ...
        <div className="container line">
          ...
          <div className="row ">
            <div className="col-xxl-12">
              <div className="sec-title-wrapper text-anim pt-130" style={{zIndex: 0}}>
          ...
          {blogs && blogs.length ? (
            <div className="row">
              {blogs.map((el) => (
                <div key={el.id} className="col-xxl-6 col-xl-6 col-lg-6">
                  <article className="blog__item-3">
                    ...
                    <div className="blog__info-3">
                      ...
                      <h5>
                        <Link href={`/blog/${el.id}`} className="blog__title-3">
                          {el.title}
                        </Link>
                      </h5>
