            ...
            <div className="col-xxl-12">
              <div className="hero__inner-3">
                <div className="sec-title-wrapper">
                  <h2 className="sec-sub-title">О компании</h2>
                  <h3 className="sec-title title-left">Naza</h3>
                  <h3 className="sec-title title-right">retty</h3>
                  {/* <h3 className="sec-title title-right">компании</h3> */}
                </div>
